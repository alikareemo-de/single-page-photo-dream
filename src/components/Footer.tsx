...
const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-app-gray py-12 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center md:text-left">
          <h2 className="text-2xl font-semibold text-gray-600 mb-6">Footer</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-500 hover:text-gray-700">Safety Information</a></li>
                <li><a href="#" className="text-gray-500 hover:text-gray-700">Cancellation Options</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-500 hover:text-gray-700">Cookie Policy</a></li>
              </ul>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-300">
            <p className="text-center text-gray-500 text-sm">
              © 2025 Property Listing. All rights reserved.
            </p>
          </div>
        </div>
      </div>
